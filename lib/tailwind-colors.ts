// Tailwind CSS v3/v4 default color palette (subset, can be expanded)
...
export const TAILWIND_COLORS = {
  ...
  amber: {
    50: '#fffbeb', 100: '#fef3c7', 200: '#fde68a', 300: '#fcd34d', 400: '#fbbf24', 500: '#f59e42', 600: '#d97706', 700: '#b45309', 800: '#92400e', 900: '#78350f',
  },
  yellow: {
  ...
  blue: {
    50: '#eff6ff', 100: '#dbeafe', 200: '#bfdbfe', 300: '#93c5fd', 400: '#60a5fa', 500: '#2563eb', 600: '#1d4ed8', 700: '#1e40af', 800: '#1e3a8a', 900: '#172554',
  },
  indigo: {
  ...
  purple: {
    50: '#faf5ff', 100: '#f3e8ff', 200: '#e9d5ff', 300: '#d8b4fe', 400: '#c084fc', 500: '#a21caf', 600: '#9333ea', 700: '#7e22ce', 800: '#6d28d9', 900: '#581c87',
  },
  fuchsia: {
...
export const DEFAULT_SHADE = 500;
